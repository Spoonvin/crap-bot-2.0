...
i32 SearcherOld::pvs(i32 alpha, i32 beta, u8 depth, u8 ply, Game& game, bool do_null) {
...
void SearcherOld::mvv_lva_reordering(MoveList& moves, Move pv_move, u8 length, Game& game, u8 ply) {
